#Log Processer and mail sender generic

# Log Processor and Mail Sender
...
def MailSender(filename, time):
    try:
        fromaddr = "your_email@gmail.com"  # Replace with your email
        toaddr = "recipient_email@gmail.com"  # Replace with recipient email
...
def ProcessLog(log_dir='ProcessLogs'):
    ...
    if connected:
        startTime = time.time()
        MailSender(log_path, time.asctime())
        endTime = time.time()
...
def main():
    ...
    if (argv[1] == "--u" or argv[1] == "--U"):
        print("Usage of the script: ApplicationName Interval_in_Minutes")
        exit()
